// config for Subsystem_Rule1 i.e corresponding to only SobelfilterIP+VDMAIP to do sobelfilter filtering
// GRIP: Generated file
//
...
#define Subsystem_Rule1_NUM_INSTANCES 0
#define Subsystem_Rule1_SOBELFILTERIP_BASEADDR 0xFFFFFFFF 	//XPAR_SOBELFILTER_S_AXI_CONTROL_BUS_BASEADDR
#define Subsystem_Rule1_SOBELFILTERIP_INTRID 0 	//XPAR_FABRIC_SOBELFILTER_0_INTERRUPT_INTR
#define Subsystem_Rule1_VDMAIP_BASEADDR 0xFFFFFFFF 	//XPAR_VDMA_S_AXI_CONTROL_BUS_BASEADDR
#define Subsystem_Rule1_VDMAIP_INTRID 0 	//XPAR_FABRIC_VDMA_0_INTERRUPT_INTR
...
Subsystem_Rule1_RegMap Subsystem_Rule1_StartMode = {
				._sobelfilterIP_RegMap = {
								.AP_CTRL = { .offset = 0x00, .mask = 0x00000000, .value = 0xffffffff},
								.GIE = { .offset = 0x04, .mask = 0x00000000, .value = 0xffffffff},
								.IER = { .offset = 0x08, .mask = 0x00000000, .value = 0xffffffff},
...
Subsystem_Rule1_RegMap Subsystem_Rule1_StopMode = {
				._sobelfilterIP_RegMap = {
								.AP_CTRL = { .offset = 0x00, .mask = 0x00000000, .value = 0xffffffff},
								.GIE = { .offset = 0x04, .mask = 0x00000000, .value = 0xffffffff},
								.IER = { .offset = 0x08, .mask = 0x00000000, .value = 0xffffffff},
