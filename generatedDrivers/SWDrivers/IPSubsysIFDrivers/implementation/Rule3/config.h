// config for Subsystem_Rule3 i.e corresponding to only SobelfilterIP+VDMAIP to do sobelfilter filtering
// GRIP: Generated file
//
...
#define Subsystem_Rule3_NUM_INSTANCES 0
#define Subsystem_Rule3_GRAYFILTERIP_BASEADDR 0xFFFFFFFF 	//XPAR_GRAYFILTER_S_AXI_CONTROL_BUS_BASEADDR
#define Subsystem_Rule3_GRAYFILTERIP_INTRID 0 	//XPAR_FABRIC_GRAYFILTER_0_INTERRUPT_INTR
#define Subsystem_Rule3_VDMAIP_BASEADDR 0xFFFFFFFF 	//XPAR_VDMA_S_AXI_CONTROL_BUS_BASEADDR
#define Subsystem_Rule3_VDMAIP_INTRID 0 	//XPAR_FABRIC_VDMA_0_INTERRUPT_INTR



Subsystem_Rule3_RegMap Subsystem_Rule3_InitMode = {
				._grayfilterIP_RegMap = {
...
Subsystem_Rule3_RegMap Subsystem_Rule3_StartMode = {
				._grayfilterIP_RegMap = {
								.AP_CTRL = { .offset = 0x00, .mask = 0x00000000, .value = 0xffffffff},
								.GIE = { .offset = 0x04, .mask = 0x00000000, .value = 0xffffffff},
								.IER = { .offset = 0x08, .mask = 0x00000000, .value = 0xffffffff},
...
Subsystem_Rule3_RegMap Subsystem_Rule3_StopMode = {
				._grayfilterIP_RegMap = {
								.AP_CTRL = { .offset = 0x00, .mask = 0x00000000, .value = 0xffffffff},
								.GIE = { .offset = 0x04, .mask = 0x00000000, .value = 0xffffffff},
								.IER = { .offset = 0x08, .mask = 0x00000000, .value = 0xffffffff},
